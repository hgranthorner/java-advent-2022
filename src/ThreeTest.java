...
class ThreeTest {
    ...
    @Test
    void solveFirst() {
        assertEquals(157, Three.solveFirst(SAMPLE));
        assertEquals(7581, Three.solveFirst(INPUT));
    }

    @Test
    void solveSecond() {
        assertEquals(70, Three.solveSecond(SAMPLE));
        assertEquals(2525, Three.solveSecond(INPUT));
    }
